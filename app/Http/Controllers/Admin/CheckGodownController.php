...
class CheckGodownController extends Controller
{
    public function index()
    {
        ...
        return view('admin.checkGodowns.index', compact('checkGodowns'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.checkGodowns.create', compact('select_products'));
    }
    ...
    public function store(StoreCheckGodownRequest $request)
    {
        ...
        return redirect()->route('admin.check-godowns.index');
    }
    ...
    public function edit(CheckGodown $checkGodown)
    {
        ...
        return view('admin.checkGodowns.edit', compact('checkGodown', 'select_products'));
    }
    ...
    public function show(CheckGodown $checkGodown)
    {
        ...
        return view('admin.checkGodowns.show', compact('checkGodown'));
    }
