...
class StockTransferApiController extends Controller
{
    public function index()
    {
        ...
        return new StockTransferResource(StockTransfer::with(['select_products', 'select_user', 'created_by'])->get());
    }
    ...
    public function show(StockTransfer $stockTransfer)
    {
        ...
        return new StockTransferResource($stockTransfer->load(['select_products', 'select_user', 'created_by']));
    }
