...
class AboutUsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.aboutUss.index', compact('aboutUss'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.aboutUss.create');
    }
    ...
    public function store(StoreAboutUsRequest $request)
    {
        ...
        return redirect()->route('frontend.about-uss.index');
    }
    ...
    public function edit(AboutUs $aboutUs)
    {
        ...
        return view('frontend.aboutUss.edit', compact('aboutUs'));
    }
    ...
    public function show(AboutUs $aboutUs)
    {
        ...
        return view('frontend.aboutUss.show', compact('aboutUs'));
    }
