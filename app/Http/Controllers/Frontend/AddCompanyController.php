...
class AddCompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.addCompanies.index', compact('addCompanies'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.addCompanies.create');
    }
    ...
    public function store(StoreAddCompanyRequest $request)
    {
        ...
        return redirect()->route('frontend.add-companies.index');
    }
    ...
    public function edit(AddCompany $addCompany)
    {
        ...
        return view('frontend.addCompanies.edit', compact('addCompany'));
    }
    ...
    public function show(AddCompany $addCompany)
    {
        ...
        return view('frontend.addCompanies.show', compact('addCompany'));
    }
