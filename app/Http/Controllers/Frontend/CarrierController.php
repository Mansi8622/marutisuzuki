...
class CarrierController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.carriers.index', compact('carriers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.carriers.create');
    }
    ...
    public function store(StoreCarrierRequest $request)
    {
        ...
        return redirect()->route('frontend.carriers.index');
    }
    ...
    public function edit(Carrier $carrier)
    {
        ...
        return view('frontend.carriers.edit', compact('carrier'));
    }
    ...
    public function show(Carrier $carrier)
    {
        ...
        return view('frontend.carriers.show', compact('carrier'));
    }
