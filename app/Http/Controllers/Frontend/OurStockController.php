...
class OurStockController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.ourStocks.index', compact('ourStocks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.ourStocks.create', compact('select_products'));
    }
    ...
    public function store(StoreOurStockRequest $request)
    {
        ...
        return redirect()->route('frontend.our-stocks.index');
    }
    ...
    public function edit(OurStock $ourStock)
    {
        ...
        return view('frontend.ourStocks.edit', compact('ourStock', 'select_products'));
    }
    ...
    public function show(OurStock $ourStock)
    {
        ...
        return view('frontend.ourStocks.show', compact('ourStock'));
    }
