...
class PrivacyPolicyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.privacyPolicies.index', compact('privacyPolicies'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.privacyPolicies.create');
    }
    ...
    public function store(StorePrivacyPolicyRequest $request)
    {
        ...
        return redirect()->route('frontend.privacy-policies.index');
    }
    ...
    public function edit(PrivacyPolicy $privacyPolicy)
    {
        ...
        return view('frontend.privacyPolicies.edit', compact('privacyPolicy'));
    }
    ...
    public function show(PrivacyPolicy $privacyPolicy)
    {
        ...
        return view('frontend.privacyPolicies.show', compact('privacyPolicy'));
    }
