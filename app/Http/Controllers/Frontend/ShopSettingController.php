...
class ShopSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.shopSettings.index', compact('shopSettings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.shopSettings.create');
    }
    ...
    public function store(StoreShopSettingRequest $request)
    {
        ...
        return redirect()->route('frontend.shop-settings.index');
    }
    ...
    public function edit(ShopSetting $shopSetting)
    {
        ...
        return view('frontend.shopSettings.edit', compact('shopSetting'));
    }
    ...
    public function show(ShopSetting $shopSetting)
    {
        ...
        return view('frontend.shopSettings.show', compact('shopSetting'));
    }
