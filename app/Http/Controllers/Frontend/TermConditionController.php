...
class TermConditionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.termConditions.index', compact('termConditions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.termConditions.create');
    }
    ...
    public function store(StoreTermConditionRequest $request)
    {
        ...
        return redirect()->route('frontend.term-conditions.index');
    }
    ...
    public function edit(TermCondition $termCondition)
    {
        ...
        return view('frontend.termConditions.edit', compact('termCondition'));
    }
    ...
    public function show(TermCondition $termCondition)
    {
        ...
        return view('frontend.termConditions.show', compact('termCondition'));
    }
