            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-orderRefunds">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  let table = $('.datatable-orderRefunds:not(.ajaxTable)').DataTable({ buttons: dtButtons })
