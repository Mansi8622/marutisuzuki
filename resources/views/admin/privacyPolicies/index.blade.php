                                    ...
                                    <tr data-entry-id="{{ $privacyPolicy->id }}">
                                        ...
                                        <td>
                                            @can('privacy_policy_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.privacy-policies.show', $privacyPolicy->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('privacy_policy_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.privacy-policies.edit', $privacyPolicy->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('privacy_policy_delete')
                                                <form action="{{ route('admin.privacy-policies.destroy', $privacyPolicy->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('privacy_policy_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.privacy-policies.massDestroy') }}",
