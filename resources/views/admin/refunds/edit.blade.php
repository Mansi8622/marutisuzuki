                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.refunds.update", [$refund->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="status" id="status" required>
                                ...
                                @foreach(App\Models\Refund::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $refund->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="note" id="note">{!! old('note', $refund->note) !!}</textarea>
                            @if($errors->has('note'))
