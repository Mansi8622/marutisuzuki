                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-StockTransfer">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.stockTransfer.fields.quantity') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                                    ...
                                    <tr data-entry-id="{{ $stockTransfer->id }}">
                                        ...
                                        <td>
                                            @foreach($stockTransfer->select_products as $key => $item)
                                                <span class="label label-info label-many">{{ $item->sku }}</span>
                                            @endforeach
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <span class="label label-info label-many">{{ $item->sku }}</span>
                                                <br>
                                                <strong>Quantity:</strong> {{ $item->pivot->quantity ?? 'N/A' }}
                                            </div>
                                        @endforeach
                                        </td>
                                        <td>
                                            ...
                                            @can('stock_transfer_edit')
                                                <a class="btn btn-xs btn-warning" href="{{ route('admin.stock-transfers.download-pdf', $stockTransfer->id) }}">
                                                    PDF
                                                </a>
                                            @endcan
                                            @can('stock_transfer_edit')
