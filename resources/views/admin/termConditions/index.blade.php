                                    ...
                                    <tr data-entry-id="{{ $termCondition->id }}">
                                        ...
                                        <td>
                                            @can('term_condition_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.term-conditions.show', $termCondition->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('term_condition_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('admin.term-conditions.edit', $termCondition->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('term_condition_delete')
                                                <form action="{{ route('admin.term-conditions.destroy', $termCondition->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
