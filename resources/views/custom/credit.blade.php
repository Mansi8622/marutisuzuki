        ...
        <div class="row">
            ...
            <div class="col-lg-9 mb-3">
              ...
              <div class=" col-lg-6 mb-3">
                <div class="card border-0 py-4" style="background: #FFE9E5;">
                  <div class="card-body text-center py-2 d-lg-flex justify-content-around align-items-center">
                    <div class="">
                        <h4 class=" mb-2" style="font-weight: 600;">Your Credit line Balance</h4>
                    <img src="asset/img/dashboard/credit.png" alt="" > 
                </div>
                    
                    <h5 class="mt-4"> ₹ 50000</h5>
                  </div>
                </div>
                </div>
