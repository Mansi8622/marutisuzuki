    ...
    <div class="card">
        <div class="card-header">
            ...
            @can('add_amount_create')
                <a class="btn btn-success btn-sm float-right" href="{{ route('frontend.add-amounts.create') }}">
                    ...
                    <tbody>
                        @foreach($addAmounts as $addAmount)
                            <tr>
                                ...
                                <td>
                                    @can('add_amount_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('frontend.add-amounts.show', $addAmount->id) }}">
                                            View
                                        </a>
                                    @endcan
