        ...
        <div class="col-md-12">
            @can('check_order_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.check-orders.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $checkOrder->id }}">
                                        ...
                                        <td>
                                            @can('check_order_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.check-orders.show', $checkOrder->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('check_order_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.check-orders.edit', $checkOrder->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('check_order_delete')
                                                <form action="{{ route('frontend.check-orders.destroy', $checkOrder->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('check_order_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.check-orders.massDestroy') }}",
