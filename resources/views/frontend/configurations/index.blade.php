                            ...
                            <tbody>
                                @foreach($configurations as $key => $configuration)
                                    <tr data-entry-id="{{ $configuration->id }}">
                                        ...
                                        <td>
                                            {{ $configuration->defaulat_tax->tax_rate ?? '' }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @can('configuration_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.configurations.show', $configuration->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('configuration_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.configurations.edit', $configuration->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan
...
@can('configuration_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.configurations.massDestroy') }}",
