    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.term-conditions.update", [$termCondition->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.termCondition.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $termCondition->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $termCondition->content) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="effective_date" id="effective_date" value="{{ old('effective_date', $termCondition->effective_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="version_number" id="version_number" value="{{ old('version_number', $termCondition->version_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="banner_title" id="banner_title" value="{{ old('banner_title', $termCondition->banner_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="banner_subtitle" id="banner_subtitle" value="{{ old('banner_subtitle', $termCondition->banner_subtitle) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id="status" required>
                                ...
                                @foreach(App\Models\TermCondition::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $termCondition->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.term-conditions.storeCKEditorImages') }}', true);
...
<script>
    ...
    url: '{{ route('frontend.term-conditions.storeMedia') }}',
    maxFilesize: 20, // MB
