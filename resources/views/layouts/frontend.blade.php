...
<style>
    ...
    @media (max-width: 767px){
        .sb-hero .carousel-caption h1{ font-size:1.9rem; }
        .sb-hero .carousel-item img{ height:380px; }
        .sb-intro .sb-frame img{ height:280px; }
        .sb-discount-content h1.display-1{ font-size:2.6rem; }
        .sb-stats .row > div{ border-right:none; border-bottom:1px solid rgba(255,255,255,0.08); }
    }
</style>
...
<div class="container sb-intro">
  <div class="row align-items-center g-5">
    ...
    <div class="col-lg-6 reveal reveal-d2">
      <div class="sb-frame">
  ...
  <div class="sb-why">
    <div class="container">
      ...
      <div class="row mt-3 g-4">
        <div class="col-lg-3 col-sm-6 reveal reveal-d1">
          <div class="card">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-sm-6 reveal reveal-d2">
          <div class="card">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-sm-6 reveal reveal-d3">
          <div class="card">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-sm-6 reveal reveal-d4">
          <div class="card">
            <div class="card-body">
